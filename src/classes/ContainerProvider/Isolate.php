...
nobody:x:65534:65534:nobody:/nonexistent:/usr/sbin/nologin");
	...
	private function buildIsolateCmd(): void
	{
		...
		$this->isolateCmd = "nice -n10 /usr/local/bin/isolate --box-id={$this->boxId} {$this->param("dir")} {$this->param("maxProcesses")} {$this->param("env")} {$this->param("chdir")} {$this->param("stdout")} {$this->param("stderr")} {$this->param("memoryLimit")} {$this->param("maxWallTime")} {$this->param("maxExecutionTime")} {$this->param("extraTime")} {$this->param("sharenet")} {$this->param("fsize")} {$this->param("maxStack")} --run -- /usr/bin/env bash -c {$cmd} 2>&1";
	}
